...
__exportStar(require("./eventInvokeConfig"), exports);
...
const eventInvokeConfig_1 = require("./eventInvokeConfig");
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "aws-native:lambda:EventInvokeConfig":
                return new eventInvokeConfig_1.EventInvokeConfig(name, undefined, { urn });
            ...
            case "aws-native:lambda:Url":
                return new url_1.Url(name, undefined, { urn });
            case "aws-native:lambda:Version":
                return new version_1.Version(name, undefined, { urn });
            default:
