 ...
 */
class EventInvokeConfig extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("EventInvokeConfig is deprecated: EventInvokeConfig is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new EventInvokeConfig(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
EventInvokeConfig.__pulumiType = 'aws-native:lambda:EventInvokeConfig';
