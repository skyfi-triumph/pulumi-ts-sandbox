...
export declare class Workteam extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Workteam;
    /**
    ...
    readonly memberDefinitions: pulumi.Output<outputs.sagemaker.WorkteamMemberDefinition[] | undefined>;
    readonly notificationConfiguration: pulumi.Output<outputs.sagemaker.WorkteamNotificationConfiguration | undefined>;
    readonly tags: pulumi.Output<outputs.sagemaker.WorkteamTag[] | undefined>;
    readonly workteamName: pulumi.Output<string | undefined>;
    /**
