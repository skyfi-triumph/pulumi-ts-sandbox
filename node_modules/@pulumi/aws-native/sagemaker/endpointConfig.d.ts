 ...
 */
export declare class EndpointConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EndpointConfig;
    /**
     * Returns true if the given object is an instance of EndpointConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EndpointConfig;
    readonly asyncInferenceConfig: pulumi.Output<outputs.sagemaker.EndpointConfigAsyncInferenceConfig | undefined>;
    readonly dataCaptureConfig: pulumi.Output<outputs.sagemaker.EndpointConfigDataCaptureConfig | undefined>;
    readonly endpointConfigName: pulumi.Output<string | undefined>;
    readonly kmsKeyId: pulumi.Output<string | undefined>;
    readonly productionVariants: pulumi.Output<outputs.sagemaker.EndpointConfigProductionVariant[]>;
    readonly tags: pulumi.Output<outputs.sagemaker.EndpointConfigTag[] | undefined>;
    /**
