...
export declare class CodeRepository extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CodeRepository;
    /**
    ...
    readonly codeRepositoryName: pulumi.Output<string | undefined>;
    readonly gitConfig: pulumi.Output<outputs.sagemaker.CodeRepositoryGitConfig>;
    readonly tags: pulumi.Output<outputs.sagemaker.CodeRepositoryTag[] | undefined>;
    /**
