...
export declare class NotebookInstance extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NotebookInstance;
    /**
    ...
    readonly notebookInstanceName: pulumi.Output<string | undefined>;
    readonly platformIdentifier: pulumi.Output<string | undefined>;
    ...
    readonly tags: pulumi.Output<outputs.sagemaker.NotebookInstanceTag[] | undefined>;
    readonly volumeSizeInGB: pulumi.Output<number | undefined>;
    /**
