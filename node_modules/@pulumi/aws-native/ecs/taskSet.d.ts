...
export declare class TaskSet extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TaskSet;
    /**
     ...
     */
    readonly launchType: pulumi.Output<enums.ecs.TaskSetLaunchType | undefined>;
     ...
     */
    readonly scale: pulumi.Output<outputs.ecs.TaskSetScale | undefined>;
    /**
     ...
     */
    readonly serviceRegistries: pulumi.Output<outputs.ecs.TaskSetServiceRegistry[] | undefined>;
    /**
