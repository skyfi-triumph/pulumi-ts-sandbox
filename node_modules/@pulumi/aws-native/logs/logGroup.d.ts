...
export declare class LogGroup extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LogGroup;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.logs.LogGroupTag[] | undefined>;
    /**
