...
class DataLakeSettings extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("DataLakeSettings is deprecated: DataLakeSettings is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new DataLakeSettings(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
DataLakeSettings.__pulumiType = 'aws-native:lakeformation:DataLakeSettings';
