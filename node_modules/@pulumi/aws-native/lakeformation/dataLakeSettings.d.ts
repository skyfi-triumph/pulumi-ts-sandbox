...
export declare class DataLakeSettings extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DataLakeSettings;
    /**
    ...
    readonly admins: pulumi.Output<outputs.lakeformation.DataLakeSettingsAdmins | undefined>;
    readonly trustedResourceOwners: pulumi.Output<string[] | undefined>;
    /**
