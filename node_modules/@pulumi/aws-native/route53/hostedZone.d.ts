 ...
 */
export declare class HostedZone extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): HostedZone;
    /**
     * Returns true if the given object is an instance of HostedZone.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is HostedZone;
    readonly hostedZoneConfig: pulumi.Output<outputs.route53.HostedZoneConfig | undefined>;
    /**
    ...
    readonly queryLoggingConfig: pulumi.Output<outputs.route53.HostedZoneQueryLoggingConfig | undefined>;
    /**
     * A complex type that contains information about the VPCs that are associated with the specified hosted zone.
     */
    readonly vPCs: pulumi.Output<outputs.route53.HostedZoneVPC[] | undefined>;
    /**
