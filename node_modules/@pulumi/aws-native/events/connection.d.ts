...
export declare class Connection extends pulumi.CustomResource {
    ...
    readonly authParameters: pulumi.Output<outputs.events.AuthParametersProperties>;
    readonly authorizationType: pulumi.Output<enums.events.ConnectionAuthorizationType>;
    /**
