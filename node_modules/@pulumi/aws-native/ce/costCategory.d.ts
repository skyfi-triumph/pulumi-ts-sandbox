...
export declare class CostCategory extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CostCategory;
    /**
    ...
    readonly ruleVersion: pulumi.Output<enums.ce.CostCategoryRuleVersion>;
    /**
     ...
     */
    readonly splitChargeRules: pulumi.Output<string | undefined>;
    /**
