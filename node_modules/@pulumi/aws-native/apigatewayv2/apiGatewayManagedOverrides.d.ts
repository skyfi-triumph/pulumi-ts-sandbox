 ...
 */
export declare class ApiGatewayManagedOverrides extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApiGatewayManagedOverrides;
    /**
     ...
     */
    static isInstance(obj: any): obj is ApiGatewayManagedOverrides;
    readonly apiId: pulumi.Output<string>;
    readonly integration: pulumi.Output<outputs.apigatewayv2.ApiGatewayManagedOverridesIntegrationOverrides | undefined>;
    readonly route: pulumi.Output<outputs.apigatewayv2.ApiGatewayManagedOverridesRouteOverrides | undefined>;
    readonly stage: pulumi.Output<outputs.apigatewayv2.ApiGatewayManagedOverridesStageOverrides | undefined>;
    /**
