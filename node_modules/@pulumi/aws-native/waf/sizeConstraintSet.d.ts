...
export declare class SizeConstraintSet extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SizeConstraintSet;
    /**
    ...
    readonly sizeConstraints: pulumi.Output<outputs.waf.SizeConstraintSetSizeConstraint[]>;
    /**
