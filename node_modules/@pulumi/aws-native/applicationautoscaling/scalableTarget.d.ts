 ...
 */
export declare class ScalableTarget extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ScalableTarget;
    /**
     * Returns true if the given object is an instance of ScalableTarget.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ScalableTarget;
    ...
    readonly scheduledActions: pulumi.Output<outputs.applicationautoscaling.ScalableTargetScheduledAction[] | undefined>;
    readonly serviceNamespace: pulumi.Output<string>;
    readonly suspendedState: pulumi.Output<outputs.applicationautoscaling.ScalableTargetSuspendedState | undefined>;
    /**
