...
export declare class Identity extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Identity;
    /**
    ...
    readonly dkimSigningEnabled: pulumi.Output<boolean | undefined>;
    readonly feedbackForwardingEnabled: pulumi.Output<boolean | undefined>;
    readonly identityDNSRecordName1: pulumi.Output<string>;
    readonly identityDNSRecordName2: pulumi.Output<string>;
    readonly identityDNSRecordName3: pulumi.Output<string>;
    readonly identityDNSRecordValue1: pulumi.Output<string>;
    readonly identityDNSRecordValue2: pulumi.Output<string>;
    readonly identityDNSRecordValue3: pulumi.Output<string>;
    readonly mailFromAttributes: pulumi.Output<outputs.pinpointemail.IdentityMailFromAttributes | undefined>;
    readonly name: pulumi.Output<string>;
    readonly tags: pulumi.Output<outputs.pinpointemail.IdentityTags[] | undefined>;
    /**
