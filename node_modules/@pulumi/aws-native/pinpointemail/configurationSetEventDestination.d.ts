...
export declare class ConfigurationSetEventDestination extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationSetEventDestination;
    /**
    ...
    readonly eventDestination: pulumi.Output<outputs.pinpointemail.ConfigurationSetEventDestinationEventDestination | undefined>;
