...
class ConfigurationSetEventDestination extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("ConfigurationSetEventDestination is deprecated: ConfigurationSetEventDestination is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new ConfigurationSetEventDestination(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
ConfigurationSetEventDestination.__pulumiType = 'aws-native:pinpointemail:ConfigurationSetEventDestination';
