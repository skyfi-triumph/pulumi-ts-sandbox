...
export declare class EnvironmentEC2 extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EnvironmentEC2;
    /**
    ...
    readonly ownerArn: pulumi.Output<string | undefined>;
    readonly repositories: pulumi.Output<outputs.cloud9.EnvironmentEC2Repository[] | undefined>;
    readonly subnetId: pulumi.Output<string | undefined>;
    readonly tags: pulumi.Output<outputs.cloud9.EnvironmentEC2Tag[] | undefined>;
    /**
