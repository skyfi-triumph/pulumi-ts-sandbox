...
export declare class OIDCProvider extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OIDCProvider;
    /**
    ...
    readonly clientIdList: pulumi.Output<string[] | undefined>;
    readonly tags: pulumi.Output<outputs.iam.OIDCProviderTag[] | undefined>;
    readonly thumbprintList: pulumi.Output<string[]>;
