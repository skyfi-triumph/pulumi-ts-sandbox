...
export declare class SAMLProvider extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SAMLProvider;
    /**
    ...
    readonly tags: pulumi.Output<outputs.iam.SAMLProviderTag[] | undefined>;
    /**
