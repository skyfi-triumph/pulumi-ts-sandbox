...
exports.UserToGroupAddition = void 0;
 ...
 */
class UserToGroupAddition extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("UserToGroupAddition is deprecated: UserToGroupAddition is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new UserToGroupAddition(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
UserToGroupAddition.__pulumiType = 'aws-native:iam:UserToGroupAddition';
//# sourceMappingURL=userToGroupAddition.js.map