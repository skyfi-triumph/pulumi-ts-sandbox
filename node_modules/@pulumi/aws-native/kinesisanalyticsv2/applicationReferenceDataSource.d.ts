 ...
 */
export declare class ApplicationReferenceDataSource extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationReferenceDataSource;
    /**
     ...
     */
    static isInstance(obj: any): obj is ApplicationReferenceDataSource;
    readonly applicationName: pulumi.Output<string>;
    readonly referenceDataSource: pulumi.Output<outputs.kinesisanalyticsv2.ApplicationReferenceDataSourceReferenceDataSource>;
    /**
 ...
 */
export interface ApplicationReferenceDataSourceArgs {
    applicationName: pulumi.Input<string>;
    referenceDataSource: pulumi.Input<inputs.kinesisanalyticsv2.ApplicationReferenceDataSourceReferenceDataSourceArgs>;
}
