 ...
 */
export declare class ApplicationOutputResource extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationOutputResource;
    /**
     ...
     */
    static isInstance(obj: any): obj is ApplicationOutputResource;
    readonly applicationName: pulumi.Output<string>;
    readonly output: pulumi.Output<outputs.kinesisanalyticsv2.ApplicationOutputResourceOutput>;
    /**
