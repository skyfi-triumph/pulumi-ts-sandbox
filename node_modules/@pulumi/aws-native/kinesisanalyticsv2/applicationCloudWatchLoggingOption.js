...
exports.ApplicationCloudWatchLoggingOption = void 0;
 ...
 */
class ApplicationCloudWatchLoggingOption extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("ApplicationCloudWatchLoggingOption is deprecated: ApplicationCloudWatchLoggingOption is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new ApplicationCloudWatchLoggingOption(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.ApplicationCloudWatchLoggingOption = ApplicationCloudWatchLoggingOption;
/** @internal */
ApplicationCloudWatchLoggingOption.__pulumiType = 'aws-native:kinesisanalyticsv2:ApplicationCloudWatchLoggingOption';
