...
exports.ApplicationOutputResource = void 0;
 ...
 */
class ApplicationOutputResource extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("ApplicationOutputResource is deprecated: ApplicationOutput is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new ApplicationOutputResource(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.ApplicationOutputResource = ApplicationOutputResource;
/** @internal */
ApplicationOutputResource.__pulumiType = 'aws-native:kinesisanalyticsv2:ApplicationOutputResource';
//# sourceMappingURL=applicationOutputResource.js.map