 ...
 */
export declare class ApplicationCloudWatchLoggingOption extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationCloudWatchLoggingOption;
    /**
     ...
     */
    static isInstance(obj: any): obj is ApplicationCloudWatchLoggingOption;
    readonly applicationName: pulumi.Output<string>;
    readonly cloudWatchLoggingOption: pulumi.Output<outputs.kinesisanalyticsv2.ApplicationCloudWatchLoggingOptionCloudWatchLoggingOption>;
    /**
