 ...
 */
export declare class GitHubRepository extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GitHubRepository;
    /**
     * Returns true if the given object is an instance of GitHubRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is GitHubRepository;
    readonly code: pulumi.Output<outputs.codestar.GitHubRepositoryCode | undefined>;
    readonly connectionArn: pulumi.Output<string | undefined>;
    readonly enableIssues: pulumi.Output<boolean | undefined>;
    readonly isPrivate: pulumi.Output<boolean | undefined>;
    readonly repositoryAccessToken: pulumi.Output<string | undefined>;
    readonly repositoryDescription: pulumi.Output<string | undefined>;
