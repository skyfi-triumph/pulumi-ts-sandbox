...
export declare class MaintenanceWindow extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MaintenanceWindow;
    /**
    ...
    readonly allowUnassociatedTargets: pulumi.Output<boolean>;
    ...
    readonly tags: pulumi.Output<outputs.ssm.MaintenanceWindowTag[] | undefined>;
    /**
