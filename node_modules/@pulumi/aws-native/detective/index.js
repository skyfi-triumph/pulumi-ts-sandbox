...
__exportStar(require("./memberInvitation"), exports);
// Import resources to register:
const graph_1 = require("./graph");
const memberInvitation_1 = require("./memberInvitation");
const _module = {
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "aws-native:detective:MemberInvitation":
                return new memberInvitation_1.MemberInvitation(name, undefined, { urn });
            default:
