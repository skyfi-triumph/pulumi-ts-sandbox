 ...
 */
class PushTemplate extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("PushTemplate is deprecated: PushTemplate is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new PushTemplate(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
PushTemplate.__pulumiType = 'aws-native:pinpoint:PushTemplate';
//# sourceMappingURL=pushTemplate.js.map