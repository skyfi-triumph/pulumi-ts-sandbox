 ...
 */
class VoiceChannel extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("VoiceChannel is deprecated: VoiceChannel is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new VoiceChannel(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
VoiceChannel.__pulumiType = 'aws-native:pinpoint:VoiceChannel';
