...
class ApplicationSettings extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("ApplicationSettings is deprecated: ApplicationSettings is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new ApplicationSettings(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
ApplicationSettings.__pulumiType = 'aws-native:pinpoint:ApplicationSettings';
