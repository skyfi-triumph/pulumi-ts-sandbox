...
class APNSSandboxChannel extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("APNSSandboxChannel is deprecated: APNSSandboxChannel is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new APNSSandboxChannel(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
APNSSandboxChannel.__pulumiType = 'aws-native:pinpoint:APNSSandboxChannel';
