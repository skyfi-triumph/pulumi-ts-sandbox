 ...
 */
export declare class PushTemplate extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PushTemplate;
    /**
     * Returns true if the given object is an instance of PushTemplate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PushTemplate;
    readonly aDM: pulumi.Output<outputs.pinpoint.PushTemplateAndroidPushNotificationTemplate | undefined>;
    readonly aPNS: pulumi.Output<outputs.pinpoint.PushTemplateAPNSPushNotificationTemplate | undefined>;
    readonly arn: pulumi.Output<string>;
    readonly baidu: pulumi.Output<outputs.pinpoint.PushTemplateAndroidPushNotificationTemplate | undefined>;
    readonly default: pulumi.Output<outputs.pinpoint.PushTemplateDefaultPushNotificationTemplate | undefined>;
    readonly defaultSubstitutions: pulumi.Output<string | undefined>;
    readonly gCM: pulumi.Output<outputs.pinpoint.PushTemplateAndroidPushNotificationTemplate | undefined>;
