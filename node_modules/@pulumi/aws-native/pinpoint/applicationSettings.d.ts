...
export declare class ApplicationSettings extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationSettings;
    /**
    ...
    readonly campaignHook: pulumi.Output<outputs.pinpoint.ApplicationSettingsCampaignHook | undefined>;
    readonly cloudWatchMetricsEnabled: pulumi.Output<boolean | undefined>;
    readonly limits: pulumi.Output<outputs.pinpoint.ApplicationSettingsLimits | undefined>;
    readonly quietTime: pulumi.Output<outputs.pinpoint.ApplicationSettingsQuietTime | undefined>;
    /**
