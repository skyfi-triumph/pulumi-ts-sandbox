...
export declare class ClientCertificate extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClientCertificate;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.apigateway.ClientCertificateTag[] | undefined>;
    /**
