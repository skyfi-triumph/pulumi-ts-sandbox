...
export declare class Cell extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Cell;
    /**
     ...
     */
    readonly cellArn: pulumi.Output<string>;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.route53recoveryreadiness.CellTag[] | undefined>;
    /**
