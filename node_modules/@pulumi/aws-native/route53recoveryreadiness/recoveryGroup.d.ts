...
export declare class RecoveryGroup extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RecoveryGroup;
    /**
     ...
     */
    readonly recoveryGroupArn: pulumi.Output<string>;
    /**
     ...
     * A collection of tags associated with a resource.
     */
    readonly tags: pulumi.Output<outputs.route53recoveryreadiness.RecoveryGroupTag[] | undefined>;
    /**
