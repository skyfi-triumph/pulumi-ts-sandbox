...
export declare class ListenerCertificate extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ListenerCertificate;
    /**
     * Returns true if the given object is an instance of ListenerCertificate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ListenerCertificate;
    readonly certificates: pulumi.Output<outputs.elasticloadbalancingv2.ListenerCertificateCertificate[]>;
