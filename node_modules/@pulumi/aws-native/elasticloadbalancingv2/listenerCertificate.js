...
class ListenerCertificate extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("ListenerCertificate is deprecated: ListenerCertificate is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new ListenerCertificate(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
ListenerCertificate.__pulumiType = 'aws-native:elasticloadbalancingv2:ListenerCertificate';
