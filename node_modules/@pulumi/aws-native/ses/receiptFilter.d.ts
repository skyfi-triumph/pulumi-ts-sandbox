...
export declare class ReceiptFilter extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReceiptFilter;
    /**
    ...
    readonly filter: pulumi.Output<outputs.ses.ReceiptFilterFilter>;
    /**
