...
export { amplify, apigateway, appflow, applicationinsights, apprunner, athena, auditmanager, budgets, cassandra, ce, cloudformation, cloudtrail, codeguruprofiler, codegurureviewer, codestarnotifications, connect, cur, customerprofiles, databrew, datasync, devicefarm, devopsguru, ec2, ecr, ecs, eks, elasticache, emr, events, evidently, finspace, fms, frauddetector, gamelift, globalaccelerator, glue, greengrassv2, groundstation, healthlake, imagebuilder, iot, iotevents, iotsitewise, iotwireless, ivs, kendra, kinesis, kinesisfirehose, kms, lambda, lex, lightsail, location, lookoutequipment, lookoutmetrics, macie, mediaconnect, mediapackage, memorydb, mwaa, networkfirewall, nimblestudio, panorama, pinpoint, quicksight, rds, redshift, refactorspaces, resiliencehub, resourcegroups, robomaker, route53, route53recoverycontrol, route53resolver, rum, s3, s3outposts, sagemaker, servicecatalog, servicecatalogappregistry, signer, ssm, ssmcontacts, ssmincidents, sso, stepfunctions, timestream, transfer, wafv2, wisdom, workspaces, };
