 ...
 */
class FlowTemplate extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("FlowTemplate is deprecated: FlowTemplate is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new FlowTemplate(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
FlowTemplate.__pulumiType = 'aws-native:iotthingsgraph:FlowTemplate';
