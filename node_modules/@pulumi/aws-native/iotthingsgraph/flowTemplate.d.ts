 ...
 */
export declare class FlowTemplate extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FlowTemplate;
    /**
     * Returns true if the given object is an instance of FlowTemplate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FlowTemplate;
    readonly compatibleNamespaceVersion: pulumi.Output<number | undefined>;
    readonly definition: pulumi.Output<outputs.iotthingsgraph.FlowTemplateDefinitionDocument>;
    /**
