 ...
 */
export declare class OrganizationConfigRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OrganizationConfigRule;
    /**
     * Returns true if the given object is an instance of OrganizationConfigRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is OrganizationConfigRule;
    readonly excludedAccounts: pulumi.Output<string[] | undefined>;
    readonly organizationConfigRuleName: pulumi.Output<string>;
    readonly organizationCustomRuleMetadata: pulumi.Output<outputs.configuration.OrganizationConfigRuleOrganizationCustomRuleMetadata | undefined>;
    readonly organizationManagedRuleMetadata: pulumi.Output<outputs.configuration.OrganizationConfigRuleOrganizationManagedRuleMetadata | undefined>;
    /**
