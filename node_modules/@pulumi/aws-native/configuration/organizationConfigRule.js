 ...
 */
class OrganizationConfigRule extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("OrganizationConfigRule is deprecated: OrganizationConfigRule is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new OrganizationConfigRule(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
OrganizationConfigRule.__pulumiType = 'aws-native:configuration:OrganizationConfigRule';
//# sourceMappingURL=organizationConfigRule.js.map