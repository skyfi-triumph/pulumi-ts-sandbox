 ...
 */
export declare class ConfigurationRecorder extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationRecorder;
    /**
     * Returns true if the given object is an instance of ConfigurationRecorder.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ConfigurationRecorder;
    readonly name: pulumi.Output<string | undefined>;
    readonly recordingGroup: pulumi.Output<outputs.configuration.ConfigurationRecorderRecordingGroup | undefined>;
