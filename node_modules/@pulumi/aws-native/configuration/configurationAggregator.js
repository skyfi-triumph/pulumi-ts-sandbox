...
class ConfigurationAggregator extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        return new ConfigurationAggregator(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
ConfigurationAggregator.__pulumiType = 'aws-native:configuration:ConfigurationAggregator';
