 ...
 */
export declare class ConfigRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigRule;
    /**
     * Returns true if the given object is an instance of ConfigRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ConfigRule;
    readonly arn: pulumi.Output<string>;
    readonly complianceType: pulumi.Output<string | undefined>;
    readonly configRuleId: pulumi.Output<string>;
    readonly configRuleName: pulumi.Output<string | undefined>;
    readonly description: pulumi.Output<string | undefined>;
    readonly inputParameters: pulumi.Output<any | undefined>;
    readonly maximumExecutionFrequency: pulumi.Output<string | undefined>;
    readonly scope: pulumi.Output<outputs.configuration.ConfigRuleScope | undefined>;
    readonly source: pulumi.Output<outputs.configuration.ConfigRuleSource>;
    /**
