...
export declare class ConformancePack extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConformancePack;
    /**
     ...
     */
    readonly conformancePackInputParameters: pulumi.Output<outputs.configuration.ConformancePackInputParameter[] | undefined>;
    /**
     * Name of the conformance pack which will be assigned as the unique identifier.
     */
    readonly conformancePackName: pulumi.Output<string>;
    /**
