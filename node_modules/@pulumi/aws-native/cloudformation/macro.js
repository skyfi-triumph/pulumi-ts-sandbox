 ...
 */
class Macro extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("Macro is deprecated: Macro is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new Macro(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.Macro = Macro;
/** @internal */
Macro.__pulumiType = 'aws-native:cloudformation:Macro';
