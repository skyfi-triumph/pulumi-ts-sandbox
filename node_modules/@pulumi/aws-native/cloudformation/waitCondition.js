 ...
 */
class WaitCondition extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("WaitCondition is deprecated: WaitCondition is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new WaitCondition(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
WaitCondition.__pulumiType = 'aws-native:cloudformation:WaitCondition';
