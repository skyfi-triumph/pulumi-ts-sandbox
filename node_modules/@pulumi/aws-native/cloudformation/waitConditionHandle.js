...
exports.WaitConditionHandle = void 0;
 ...
 */
class WaitConditionHandle extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("WaitConditionHandle is deprecated: WaitConditionHandle is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new WaitConditionHandle(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
WaitConditionHandle.__pulumiType = 'aws-native:cloudformation:WaitConditionHandle';
