...
export { accessanalyzer, acmpca, amazonmq, amplify, apigateway, apigatewayv2, appconfig, appflow, appintegrations, applicationautoscaling, applicationinsights, appmesh, apprunner, appstream, appsync, aps, ask, athena, auditmanager, autoscaling, autoscalingplans, backup, batch, budgets, cassandra, ce, certificatemanager, chatbot, cloud9, cloudformation, cloudfront, cloudtrail, cloudwatch, codeartifact, codebuild, codecommit, codedeploy, codeguruprofiler, codegurureviewer, codepipeline, codestar, codestarconnections, codestarnotifications, cognito, config, configuration, connect, cur, customerprofiles, databrew, datapipeline, datasync, dax, detective, devicefarm, devopsguru, directoryservice, dlm, dms, docdb, dynamodb, ec2, ecr, ecs, efs, eks, elasticache, elasticbeanstalk, elasticloadbalancing, elasticloadbalancingv2, elasticsearch, emr, emrcontainers, events, eventschemas, evidently, finspace, fis, fms, frauddetector, fsx, gamelift, globalaccelerator, glue, greengrass, greengrassv2, groundstation, guardduty, healthlake, iam, imagebuilder, inspector, iot, iot1click, iotanalytics, iotcoredeviceadvisor, iotevents, iotfleethub, iotsitewise, iotthingsgraph, iotwireless, ivs, kendra, kinesis, kinesisanalytics, kinesisanalyticsv2, kinesisfirehose, kms, lakeformation, lambda, lex, licensemanager, lightsail, location, logs, lookoutequipment, lookoutmetrics, lookoutvision, macie, managedblockchain, mediaconnect, mediaconvert, medialive, mediapackage, mediastore, memorydb, msk, mwaa, neptune, networkfirewall, networkmanager, nimblestudio, opensearchservice, opsworks, opsworkscm, panorama, pinpoint, pinpointemail, qldb, quicksight, ram, rds, redshift, refactorspaces, rekognition, resiliencehub, resourcegroups, robomaker, route53, route53recoverycontrol, route53recoveryreadiness, route53resolver, rum, s3, s3objectlambda, s3outposts, sagemaker, sdb, secretsmanager, securityhub, servicecatalog, servicecatalogappregistry, servicediscovery, ses, signer, sns, sqs, ssm, ssmcontacts, ssmincidents, sso, stepfunctions, synthetics, timestream, transfer, types, waf, wafregional, wafv2, wisdom, workspaces, xray, };
