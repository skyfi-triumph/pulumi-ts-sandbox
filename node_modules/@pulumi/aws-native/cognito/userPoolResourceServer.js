...
exports.UserPoolResourceServer = void 0;
 ...
 */
class UserPoolResourceServer extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("UserPoolResourceServer is deprecated: UserPoolResourceServer is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new UserPoolResourceServer(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
UserPoolResourceServer.__pulumiType = 'aws-native:cognito:UserPoolResourceServer';
//# sourceMappingURL=userPoolResourceServer.js.map