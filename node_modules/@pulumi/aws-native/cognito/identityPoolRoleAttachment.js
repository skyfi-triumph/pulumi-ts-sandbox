...
class IdentityPoolRoleAttachment extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("IdentityPoolRoleAttachment is deprecated: IdentityPoolRoleAttachment is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new IdentityPoolRoleAttachment(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
IdentityPoolRoleAttachment.__pulumiType = 'aws-native:cognito:IdentityPoolRoleAttachment';
