...
exports.UserPoolUserToGroupAttachment = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
/**
 * Resource Type definition for AWS::Cognito::UserPoolUserToGroupAttachment
 *
 * @deprecated UserPoolUserToGroupAttachment is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.
 */
class UserPoolUserToGroupAttachment extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("UserPoolUserToGroupAttachment is deprecated: UserPoolUserToGroupAttachment is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new UserPoolUserToGroupAttachment(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
UserPoolUserToGroupAttachment.__pulumiType = 'aws-native:cognito:UserPoolUserToGroupAttachment';
