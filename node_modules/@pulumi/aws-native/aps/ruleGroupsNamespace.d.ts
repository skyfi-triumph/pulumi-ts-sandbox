 ...
 */
export declare class RuleGroupsNamespace extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RuleGroupsNamespace;
    /**
     * Returns true if the given object is an instance of RuleGroupsNamespace.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RuleGroupsNamespace;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.aps.RuleGroupsNamespaceTag[] | undefined>;
    /**
