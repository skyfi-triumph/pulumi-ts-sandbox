...
export declare class ApplicationVersion extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationVersion;
    /**
    ...
    readonly sourceBundle: pulumi.Output<outputs.elasticbeanstalk.ApplicationVersionSourceBundle>;
    /**
