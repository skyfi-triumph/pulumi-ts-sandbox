...
__exportStar(require("./configurationTemplate"), exports);
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "aws-native:elasticbeanstalk:ApplicationVersion":
                return new applicationVersion_1.ApplicationVersion(name, undefined, { urn });
            case "aws-native:elasticbeanstalk:ConfigurationTemplate":
                return new configurationTemplate_1.ConfigurationTemplate(name, undefined, { urn });
