 ...
 */
class GraphQLSchema extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("GraphQLSchema is deprecated: GraphQLSchema is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new GraphQLSchema(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
GraphQLSchema.__pulumiType = 'aws-native:appsync:GraphQLSchema';
