...
export declare class GraphQLApi extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GraphQLApi;
    /**
    ...
    readonly additionalAuthenticationProviders: pulumi.Output<outputs.appsync.GraphQLApiAdditionalAuthenticationProviders | undefined>;
    ...
    readonly tags: pulumi.Output<outputs.appsync.GraphQLApiTags | undefined>;
