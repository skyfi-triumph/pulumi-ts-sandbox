 ...
 */
export declare class ResourceDefinitionVersion extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResourceDefinitionVersion;
    /**
     ...
     */
    static isInstance(obj: any): obj is ResourceDefinitionVersion;
    readonly resourceDefinitionId: pulumi.Output<string>;
    readonly resources: pulumi.Output<outputs.greengrass.ResourceDefinitionVersionResourceInstance[]>;
    /**
