 ...
 */
class ResourceDefinitionVersion extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("ResourceDefinitionVersion is deprecated: ResourceDefinitionVersion is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new ResourceDefinitionVersion(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
ResourceDefinitionVersion.__pulumiType = 'aws-native:greengrass:ResourceDefinitionVersion';
//# sourceMappingURL=resourceDefinitionVersion.js.map