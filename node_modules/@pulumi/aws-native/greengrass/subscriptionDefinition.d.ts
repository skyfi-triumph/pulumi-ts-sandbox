 ...
 */
export declare class SubscriptionDefinition extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SubscriptionDefinition;
    /**
     * Returns true if the given object is an instance of SubscriptionDefinition.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SubscriptionDefinition;
    readonly arn: pulumi.Output<string>;
    readonly initialVersion: pulumi.Output<outputs.greengrass.SubscriptionDefinitionVersion | undefined>;
    readonly latestVersionArn: pulumi.Output<string>;
