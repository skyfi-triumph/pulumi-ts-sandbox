 ...
 */
class FunctionDefinition extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("FunctionDefinition is deprecated: FunctionDefinition is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new FunctionDefinition(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
FunctionDefinition.__pulumiType = 'aws-native:greengrass:FunctionDefinition';
