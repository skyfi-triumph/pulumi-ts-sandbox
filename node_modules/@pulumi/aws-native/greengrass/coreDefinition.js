 ...
 */
class CoreDefinition extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("CoreDefinition is deprecated: CoreDefinition is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new CoreDefinition(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.CoreDefinition = CoreDefinition;
/** @internal */
CoreDefinition.__pulumiType = 'aws-native:greengrass:CoreDefinition';
//# sourceMappingURL=coreDefinition.js.map