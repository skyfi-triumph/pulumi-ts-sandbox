 ...
 */
export declare class SubscriptionDefinitionVersion extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SubscriptionDefinitionVersion;
    /**
     ...
     */
    static isInstance(obj: any): obj is SubscriptionDefinitionVersion;
    readonly subscriptionDefinitionId: pulumi.Output<string>;
    readonly subscriptions: pulumi.Output<outputs.greengrass.SubscriptionDefinitionVersionSubscription[]>;
    /**
