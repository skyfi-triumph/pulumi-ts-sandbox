 ...
 */
class GroupVersion extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("GroupVersion is deprecated: GroupVersion is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new GroupVersion(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
GroupVersion.__pulumiType = 'aws-native:greengrass:GroupVersion';
//# sourceMappingURL=groupVersion.js.map