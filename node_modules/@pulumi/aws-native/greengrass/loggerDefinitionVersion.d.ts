 ...
 */
export declare class LoggerDefinitionVersion extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LoggerDefinitionVersion;
    /**
     * Returns true if the given object is an instance of LoggerDefinitionVersion.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LoggerDefinitionVersion;
    readonly loggerDefinitionId: pulumi.Output<string>;
    readonly loggers: pulumi.Output<outputs.greengrass.LoggerDefinitionVersionLogger[]>;
    /**
