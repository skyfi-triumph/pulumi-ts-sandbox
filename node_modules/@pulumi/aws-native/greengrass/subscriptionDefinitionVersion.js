...
exports.SubscriptionDefinitionVersion = void 0;
 ...
 */
class SubscriptionDefinitionVersion extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("SubscriptionDefinitionVersion is deprecated: SubscriptionDefinitionVersion is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new SubscriptionDefinitionVersion(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
SubscriptionDefinitionVersion.__pulumiType = 'aws-native:greengrass:SubscriptionDefinitionVersion';
//# sourceMappingURL=subscriptionDefinitionVersion.js.map