 ...
 */
export declare class ConnectorDefinitionVersion extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConnectorDefinitionVersion;
    /**
     ...
     */
    static isInstance(obj: any): obj is ConnectorDefinitionVersion;
    readonly connectorDefinitionId: pulumi.Output<string>;
    readonly connectors: pulumi.Output<outputs.greengrass.ConnectorDefinitionVersionConnector[]>;
    /**
