 ...
 */
export declare class DeviceDefinitionVersion extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DeviceDefinitionVersion;
    /**
     * Returns true if the given object is an instance of DeviceDefinitionVersion.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DeviceDefinitionVersion;
    readonly deviceDefinitionId: pulumi.Output<string>;
    readonly devices: pulumi.Output<outputs.greengrass.DeviceDefinitionVersionDevice[]>;
    /**
