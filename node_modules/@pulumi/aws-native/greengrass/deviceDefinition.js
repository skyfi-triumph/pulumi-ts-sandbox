 ...
 */
class DeviceDefinition extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("DeviceDefinition is deprecated: DeviceDefinition is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new DeviceDefinition(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
DeviceDefinition.__pulumiType = 'aws-native:greengrass:DeviceDefinition';
