 ...
 */
export declare class FunctionDefinition extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FunctionDefinition;
    /**
     * Returns true if the given object is an instance of FunctionDefinition.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FunctionDefinition;
    readonly arn: pulumi.Output<string>;
    readonly initialVersion: pulumi.Output<outputs.greengrass.FunctionDefinitionVersion | undefined>;
