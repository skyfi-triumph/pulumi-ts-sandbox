 ...
 */
export declare class ConnectorDefinition extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConnectorDefinition;
    /**
     * Returns true if the given object is an instance of ConnectorDefinition.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ConnectorDefinition;
    readonly arn: pulumi.Output<string>;
    readonly initialVersion: pulumi.Output<outputs.greengrass.ConnectorDefinitionVersion | undefined>;
