 ...
 */
class DeviceDefinitionVersion extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("DeviceDefinitionVersion is deprecated: DeviceDefinitionVersion is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new DeviceDefinitionVersion(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
DeviceDefinitionVersion.__pulumiType = 'aws-native:greengrass:DeviceDefinitionVersion';
//# sourceMappingURL=deviceDefinitionVersion.js.map