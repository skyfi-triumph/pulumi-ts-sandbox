 ...
 */
class CoreDefinitionVersion extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("CoreDefinitionVersion is deprecated: CoreDefinitionVersion is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new CoreDefinitionVersion(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
CoreDefinitionVersion.__pulumiType = 'aws-native:greengrass:CoreDefinitionVersion';
//# sourceMappingURL=coreDefinitionVersion.js.map