 ...
 */
class SubscriptionDefinition extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("SubscriptionDefinition is deprecated: SubscriptionDefinition is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new SubscriptionDefinition(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
SubscriptionDefinition.__pulumiType = 'aws-native:greengrass:SubscriptionDefinition';
