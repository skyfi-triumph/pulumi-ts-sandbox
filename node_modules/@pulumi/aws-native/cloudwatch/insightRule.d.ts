 ...
 */
export declare class InsightRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InsightRule;
    /**
     * Returns true if the given object is an instance of InsightRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is InsightRule;
    readonly arn: pulumi.Output<string>;
    readonly ruleBody: pulumi.Output<string>;
    readonly ruleName: pulumi.Output<string>;
    readonly ruleState: pulumi.Output<string>;
    readonly tags: pulumi.Output<outputs.cloudwatch.InsightRuleTags | undefined>;
    /**
