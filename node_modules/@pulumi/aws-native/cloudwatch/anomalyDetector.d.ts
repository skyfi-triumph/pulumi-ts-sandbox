...
export declare class AnomalyDetector extends pulumi.CustomResource {
    ...
    readonly configuration: pulumi.Output<outputs.cloudwatch.AnomalyDetectorConfiguration | undefined>;
    readonly dimensions: pulumi.Output<outputs.cloudwatch.AnomalyDetectorDimension[] | undefined>;
    readonly metricMathAnomalyDetector: pulumi.Output<outputs.cloudwatch.AnomalyDetectorMetricMathAnomalyDetector | undefined>;
    readonly metricName: pulumi.Output<string | undefined>;
    readonly namespace: pulumi.Output<string | undefined>;
    readonly singleMetricAnomalyDetector: pulumi.Output<outputs.cloudwatch.AnomalyDetectorSingleMetricAnomalyDetector | undefined>;
    readonly stat: pulumi.Output<string | undefined>;
    /**
