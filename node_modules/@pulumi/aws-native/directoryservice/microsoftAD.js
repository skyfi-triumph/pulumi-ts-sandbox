 ...
 */
class MicrosoftAD extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("MicrosoftAD is deprecated: MicrosoftAD is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new MicrosoftAD(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.MicrosoftAD = MicrosoftAD;
/** @internal */
MicrosoftAD.__pulumiType = 'aws-native:directoryservice:MicrosoftAD';
//# sourceMappingURL=microsoftAD.js.map