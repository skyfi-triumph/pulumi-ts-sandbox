 ...
 */
export declare class MicrosoftAD extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MicrosoftAD;
    /**
     * Returns true if the given object is an instance of MicrosoftAD.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MicrosoftAD;
    readonly alias: pulumi.Output<string>;
    readonly createAlias: pulumi.Output<boolean | undefined>;
    ...
    readonly vpcSettings: pulumi.Output<outputs.directoryservice.MicrosoftADVpcSettings>;
    /**
