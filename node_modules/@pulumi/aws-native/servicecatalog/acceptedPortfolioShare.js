 ...
 */
class AcceptedPortfolioShare extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("AcceptedPortfolioShare is deprecated: AcceptedPortfolioShare is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new AcceptedPortfolioShare(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.AcceptedPortfolioShare = AcceptedPortfolioShare;
/** @internal */
AcceptedPortfolioShare.__pulumiType = 'aws-native:servicecatalog:AcceptedPortfolioShare';
//# sourceMappingURL=acceptedPortfolioShare.js.map