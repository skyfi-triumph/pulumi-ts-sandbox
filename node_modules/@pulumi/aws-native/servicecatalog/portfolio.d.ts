...
export declare class Portfolio extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Portfolio;
    /**
    ...
    readonly portfolioName: pulumi.Output<string>;
    readonly providerName: pulumi.Output<string>;
    readonly tags: pulumi.Output<outputs.servicecatalog.PortfolioTag[] | undefined>;
    /**
