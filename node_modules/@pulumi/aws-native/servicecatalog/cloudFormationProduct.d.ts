...
export declare class CloudFormationProduct extends pulumi.CustomResource {
    ...
    readonly provisioningArtifactParameters: pulumi.Output<outputs.servicecatalog.CloudFormationProductProvisioningArtifactProperties[]>;
    ...
    readonly tags: pulumi.Output<outputs.servicecatalog.CloudFormationProductTag[] | undefined>;
    /**
