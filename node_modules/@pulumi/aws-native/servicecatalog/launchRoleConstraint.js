...
exports.LaunchRoleConstraint = void 0;
 ...
 */
class LaunchRoleConstraint extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("LaunchRoleConstraint is deprecated: LaunchRoleConstraint is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new LaunchRoleConstraint(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.LaunchRoleConstraint = LaunchRoleConstraint;
/** @internal */
LaunchRoleConstraint.__pulumiType = 'aws-native:servicecatalog:LaunchRoleConstraint';
//# sourceMappingURL=launchRoleConstraint.js.map