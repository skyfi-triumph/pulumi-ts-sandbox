...
export declare class EntityType extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EntityType;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.frauddetector.EntityTypeTag[] | undefined>;
    /**
