...
export declare class Label extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Label;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.frauddetector.LabelTag[] | undefined>;
    /**
