...
export declare class Budget extends pulumi.CustomResource {
    ...
    readonly budget: pulumi.Output<outputs.budgets.BudgetData>;
    readonly notificationsWithSubscribers: pulumi.Output<outputs.budgets.BudgetNotificationWithSubscribers[] | undefined>;
    /**
