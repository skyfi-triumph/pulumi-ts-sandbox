...
export declare class TrafficMirrorTarget extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TrafficMirrorTarget;
    /**
    ...
    readonly tags: pulumi.Output<outputs.ec2.TrafficMirrorTargetTag[] | undefined>;
    /**
