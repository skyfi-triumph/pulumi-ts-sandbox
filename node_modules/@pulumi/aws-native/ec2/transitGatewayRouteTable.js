...
exports.TransitGatewayRouteTable = void 0;
 ...
 */
class TransitGatewayRouteTable extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("TransitGatewayRouteTable is deprecated: TransitGatewayRouteTable is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new TransitGatewayRouteTable(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.TransitGatewayRouteTable = TransitGatewayRouteTable;
/** @internal */
TransitGatewayRouteTable.__pulumiType = 'aws-native:ec2:TransitGatewayRouteTable';
//# sourceMappingURL=transitGatewayRouteTable.js.map