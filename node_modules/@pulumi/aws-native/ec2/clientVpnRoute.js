 ...
 */
class ClientVpnRoute extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("ClientVpnRoute is deprecated: ClientVpnRoute is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new ClientVpnRoute(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
ClientVpnRoute.__pulumiType = 'aws-native:ec2:ClientVpnRoute';
//# sourceMappingURL=clientVpnRoute.js.map