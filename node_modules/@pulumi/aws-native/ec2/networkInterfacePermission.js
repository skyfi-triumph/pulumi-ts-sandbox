...
class NetworkInterfacePermission extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("NetworkInterfacePermission is deprecated: NetworkInterfacePermission is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new NetworkInterfacePermission(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
NetworkInterfacePermission.__pulumiType = 'aws-native:ec2:NetworkInterfacePermission';
