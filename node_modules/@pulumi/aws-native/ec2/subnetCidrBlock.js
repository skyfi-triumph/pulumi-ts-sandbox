...
exports.SubnetCidrBlock = void 0;
 ...
 */
class SubnetCidrBlock extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("SubnetCidrBlock is deprecated: SubnetCidrBlock is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new SubnetCidrBlock(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.SubnetCidrBlock = SubnetCidrBlock;
/** @internal */
SubnetCidrBlock.__pulumiType = 'aws-native:ec2:SubnetCidrBlock';
//# sourceMappingURL=subnetCidrBlock.js.map