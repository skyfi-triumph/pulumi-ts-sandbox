...
export declare class DHCPOptions extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DHCPOptions;
    /**
     ...
     */
    readonly netbiosNodeType: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.ec2.DHCPOptionsTag[] | undefined>;
    /**
