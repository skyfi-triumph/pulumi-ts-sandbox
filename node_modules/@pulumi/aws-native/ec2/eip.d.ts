...
export declare class EIP extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EIP;
    /**
    ...
    readonly publicIpv4Pool: pulumi.Output<string | undefined>;
    readonly tags: pulumi.Output<outputs.ec2.EIPTag[] | undefined>;
    /**
