...
class TrafficMirrorTarget extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("TrafficMirrorTarget is deprecated: TrafficMirrorTarget is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new TrafficMirrorTarget(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
TrafficMirrorTarget.__pulumiType = 'aws-native:ec2:TrafficMirrorTarget';
