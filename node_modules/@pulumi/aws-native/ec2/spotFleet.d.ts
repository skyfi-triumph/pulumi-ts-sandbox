 ...
 */
export declare class SpotFleet extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SpotFleet;
    /**
     * Returns true if the given object is an instance of SpotFleet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SpotFleet;
    readonly spotFleetRequestConfigData: pulumi.Output<outputs.ec2.SpotFleetRequestConfigData>;
    /**
