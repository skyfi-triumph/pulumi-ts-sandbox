...
export declare class NetworkAcl extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkAcl;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.ec2.NetworkAclTag[] | undefined>;
    /**
     * The ID of the VPC.
     */
