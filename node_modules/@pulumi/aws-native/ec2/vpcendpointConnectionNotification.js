...
class VPCEndpointConnectionNotification extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("VPCEndpointConnectionNotification is deprecated: VPCEndpointConnectionNotification is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new VPCEndpointConnectionNotification(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
VPCEndpointConnectionNotification.__pulumiType = 'aws-native:ec2:VPCEndpointConnectionNotification';
