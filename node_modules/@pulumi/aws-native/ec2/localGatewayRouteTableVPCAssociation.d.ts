...
export declare class LocalGatewayRouteTableVPCAssociation extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LocalGatewayRouteTableVPCAssociation;
    /**
     ...
     */
    readonly localGatewayRouteTableVpcAssociationId: pulumi.Output<string>;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.ec2.LocalGatewayRouteTableVPCAssociationTag[] | undefined>;
    /**
     * The ID of the VPC.
     */
