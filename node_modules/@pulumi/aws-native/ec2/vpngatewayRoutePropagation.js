...
class VPNGatewayRoutePropagation extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("VPNGatewayRoutePropagation is deprecated: VPNGatewayRoutePropagation is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new VPNGatewayRoutePropagation(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
VPNGatewayRoutePropagation.__pulumiType = 'aws-native:ec2:VPNGatewayRoutePropagation';
