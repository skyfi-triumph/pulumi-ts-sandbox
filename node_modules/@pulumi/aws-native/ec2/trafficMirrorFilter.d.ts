...
export declare class TrafficMirrorFilter extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TrafficMirrorFilter;
    /**
    ...
    readonly tags: pulumi.Output<outputs.ec2.TrafficMirrorFilterTag[] | undefined>;
    /**
