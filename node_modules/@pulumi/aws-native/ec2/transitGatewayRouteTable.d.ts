 ...
 */
export declare class TransitGatewayRouteTable extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TransitGatewayRouteTable;
    /**
     * Returns true if the given object is an instance of TransitGatewayRouteTable.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TransitGatewayRouteTable;
    readonly tags: pulumi.Output<outputs.ec2.TransitGatewayRouteTableTag[] | undefined>;
