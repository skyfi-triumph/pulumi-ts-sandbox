...
exports.GatewayRouteTableAssociation = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
/**
 * Associates a gateway with a route table. The gateway and route table must be in the same VPC. This association causes the incoming traffic to the gateway to be routed according to the routes in the route table.
 */
class GatewayRouteTableAssociation extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new GatewayRouteTableAssociation(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.GatewayRouteTableAssociation = GatewayRouteTableAssociation;
/** @internal */
GatewayRouteTableAssociation.__pulumiType = 'aws-native:ec2:GatewayRouteTableAssociation';
//# sourceMappingURL=gatewayRouteTableAssociation.js.map