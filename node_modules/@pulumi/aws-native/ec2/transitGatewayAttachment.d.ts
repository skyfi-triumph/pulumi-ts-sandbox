...
export declare class TransitGatewayAttachment extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TransitGatewayAttachment;
    /**
    ...
    readonly tags: pulumi.Output<outputs.ec2.TransitGatewayAttachmentTag[] | undefined>;
