...
export declare class ReplicationTask extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationTask;
    /**
    ...
    readonly cdcStartPosition: pulumi.Output<string | undefined>;
    readonly cdcStartTime: pulumi.Output<number | undefined>;
    readonly cdcStopPosition: pulumi.Output<string | undefined>;
    readonly migrationType: pulumi.Output<string>;
    readonly replicationInstanceArn: pulumi.Output<string>;
    readonly replicationTaskIdentifier: pulumi.Output<string | undefined>;
    ...
    readonly tags: pulumi.Output<outputs.dms.ReplicationTaskTag[] | undefined>;
    readonly targetEndpointArn: pulumi.Output<string>;
    readonly taskData: pulumi.Output<string | undefined>;
    /**
