...
export declare class ReplicationSubnetGroup extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationSubnetGroup;
    /**
    ...
    readonly tags: pulumi.Output<outputs.dms.ReplicationSubnetGroupTag[] | undefined>;
    /**
