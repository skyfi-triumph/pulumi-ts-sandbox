...
export declare class GlobalNetwork extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GlobalNetwork;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.networkmanager.GlobalNetworkTag[] | undefined>;
    /**
