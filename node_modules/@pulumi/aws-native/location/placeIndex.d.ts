...
export declare class PlaceIndex extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PlaceIndex;
    /**
    ...
    readonly dataSourceConfiguration: pulumi.Output<outputs.location.PlaceIndexDataSourceConfiguration | undefined>;
    readonly description: pulumi.Output<string | undefined>;
    readonly indexArn: pulumi.Output<string>;
    readonly indexName: pulumi.Output<string>;
    readonly pricingPlan: pulumi.Output<enums.location.PlaceIndexPricingPlan>;
