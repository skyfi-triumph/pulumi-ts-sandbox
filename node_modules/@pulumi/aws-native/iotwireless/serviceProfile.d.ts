...
export declare class ServiceProfile extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServiceProfile;
    /**
     ...
     */
    readonly loRaWAN: pulumi.Output<outputs.iotwireless.ServiceProfileLoRaWANServiceProfile | undefined>;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.iotwireless.ServiceProfileTag[] | undefined>;
    /**
