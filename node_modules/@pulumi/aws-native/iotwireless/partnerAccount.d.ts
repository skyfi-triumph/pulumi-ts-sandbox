 ...
 */
export declare class PartnerAccount extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PartnerAccount;
    /**
     * Returns true if the given object is an instance of PartnerAccount.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PartnerAccount;
    /**
     * Whether the partner account is linked to the AWS account.
     */
    readonly accountLinked: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly partnerAccountId: pulumi.Output<string | undefined>;
    /**
     * The partner type
     */
    readonly partnerType: pulumi.Output<enums.iotwireless.PartnerAccountPartnerType | undefined>;
    /**
     * The Sidewalk account credentials.
     */
    readonly sidewalk: pulumi.Output<outputs.iotwireless.PartnerAccountSidewalkAccountInfo | undefined>;
    /**
     * The Sidewalk account credentials.
     */
    readonly sidewalkResponse: pulumi.Output<outputs.iotwireless.PartnerAccountSidewalkAccountInfoWithFingerprint>;
    /**
     * The Sidewalk account credentials.
     */
    readonly sidewalkUpdate: pulumi.Output<outputs.iotwireless.PartnerAccountSidewalkUpdateAccount | undefined>;
    /**
     * A list of key-value pairs that contain metadata for the destination.
     */
    readonly tags: pulumi.Output<outputs.iotwireless.PartnerAccountTag[] | undefined>;
    /**
