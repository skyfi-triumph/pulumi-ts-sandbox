...
export declare class ResolverRule extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResolverRule;
    /**
     ...
     */
    readonly ruleType: pulumi.Output<enums.route53resolver.ResolverRuleRuleType>;
    /**
     * An array of key-value pairs to apply to this resource.
     */
    readonly tags: pulumi.Output<outputs.route53resolver.ResolverRuleTag[] | undefined>;
    /**
     * An array that contains the IP addresses and ports that an outbound endpoint forwards DNS queries to. Typically, these are the IP addresses of DNS resolvers on your network. Specify IPv4 addresses. IPv6 is not supported.
     */
    readonly targetIps: pulumi.Output<outputs.route53resolver.ResolverRuleTargetAddress[] | undefined>;
    /**
