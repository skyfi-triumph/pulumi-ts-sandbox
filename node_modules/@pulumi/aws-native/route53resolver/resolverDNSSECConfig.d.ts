...
export declare class ResolverDNSSECConfig extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResolverDNSSECConfig;
    /**
     ...
     */
    readonly validationStatus: pulumi.Output<enums.route53resolver.ResolverDNSSECConfigValidationStatus>;
    /**
