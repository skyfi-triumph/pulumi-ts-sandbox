...
export declare class ResolverRuleAssociation extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResolverRuleAssociation;
    /**
    ...
    readonly resolverRuleAssociationId: pulumi.Output<string>;
