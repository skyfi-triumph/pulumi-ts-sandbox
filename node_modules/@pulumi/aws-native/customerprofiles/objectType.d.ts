 ...
 */
export declare class ObjectType extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ObjectType;
    /**
     * Returns true if the given object is an instance of ObjectType.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ObjectType;
    /**
     * Indicates whether a profile should be created when data is received.
     */
    readonly allowProfileCreation: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly fields: pulumi.Output<outputs.customerprofiles.ObjectTypeFieldMap[] | undefined>;
    /**
     * A list of unique keys that can be used to map data to the profile.
     */
    readonly keys: pulumi.Output<outputs.customerprofiles.ObjectTypeKeyMap[] | undefined>;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.customerprofiles.ObjectTypeTag[] | undefined>;
    /**
