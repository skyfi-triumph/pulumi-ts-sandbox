...
class WebACLAssociation extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("WebACLAssociation is deprecated: WebACLAssociation is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new WebACLAssociation(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
WebACLAssociation.__pulumiType = 'aws-native:wafregional:WebACLAssociation';
