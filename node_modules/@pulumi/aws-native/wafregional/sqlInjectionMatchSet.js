...
class SqlInjectionMatchSet extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("SqlInjectionMatchSet is deprecated: SqlInjectionMatchSet is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new SqlInjectionMatchSet(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
SqlInjectionMatchSet.__pulumiType = 'aws-native:wafregional:SqlInjectionMatchSet';
