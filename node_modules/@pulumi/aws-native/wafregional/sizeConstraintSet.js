...
class SizeConstraintSet extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("SizeConstraintSet is deprecated: SizeConstraintSet is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new SizeConstraintSet(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
SizeConstraintSet.__pulumiType = 'aws-native:wafregional:SizeConstraintSet';
