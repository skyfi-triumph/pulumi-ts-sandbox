...
export declare class IPSet extends pulumi.CustomResource {
    ...
    readonly iPSetDescriptors: pulumi.Output<outputs.wafregional.IPSetDescriptor[] | undefined>;
...
export interface IPSetArgs {
    iPSetDescriptors?: pulumi.Input<pulumi.Input<inputs.wafregional.IPSetDescriptorArgs>[]>;
