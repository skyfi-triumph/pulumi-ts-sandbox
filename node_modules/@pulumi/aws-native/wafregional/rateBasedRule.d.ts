...
export declare class RateBasedRule extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RateBasedRule;
    /**
    ...
    readonly matchPredicates: pulumi.Output<outputs.wafregional.RateBasedRulePredicate[] | undefined>;
