...
export declare class OriginEndpoint extends pulumi.CustomResource {
    ...
    readonly authorization: pulumi.Output<outputs.mediapackage.OriginEndpointAuthorization | undefined>;
    /**
     * The ID of the Channel the OriginEndpoint is associated with.
     */
    readonly channelId: pulumi.Output<string>;
    readonly cmafPackage: pulumi.Output<outputs.mediapackage.OriginEndpointCmafPackage | undefined>;
    readonly dashPackage: pulumi.Output<outputs.mediapackage.OriginEndpointDashPackage | undefined>;
    /**
     * A short text description of the OriginEndpoint.
     */
    readonly description: pulumi.Output<string | undefined>;
    readonly hlsPackage: pulumi.Output<outputs.mediapackage.OriginEndpointHlsPackage | undefined>;
    /**
     * A short string appended to the end of the OriginEndpoint URL.
     */
    readonly manifestName: pulumi.Output<string | undefined>;
    readonly mssPackage: pulumi.Output<outputs.mediapackage.OriginEndpointMssPackage | undefined>;
    /**
     * Control whether origination of video is allowed for this OriginEndpoint. If set to ALLOW, the OriginEndpoint may by requested, pursuant to any other form of access control. If set to DENY, the OriginEndpoint may not be requested. This can be helpful for Live to VOD harvesting, or for temporarily disabling origination
     */
    readonly origination: pulumi.Output<enums.mediapackage.OriginEndpointOrigination | undefined>;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.mediapackage.OriginEndpointTag[] | undefined>;
    /**
     * Amount of delay (seconds) to enforce on the playback of live content. If not specified, there will be no time delay in effect for the OriginEndpoint.
     */
    readonly timeDelaySeconds: pulumi.Output<number | undefined>;
    /**
