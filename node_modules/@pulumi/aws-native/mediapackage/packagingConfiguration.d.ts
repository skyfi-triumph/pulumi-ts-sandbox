 ...
 */
export declare class PackagingConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PackagingConfiguration;
    /**
     * Returns true if the given object is an instance of PackagingConfiguration.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PackagingConfiguration;
    /**
     ...
     */
    readonly cmafPackage: pulumi.Output<outputs.mediapackage.PackagingConfigurationCmafPackage | undefined>;
    /**
     * A Dynamic Adaptive Streaming over HTTP (DASH) packaging configuration.
     */
    readonly dashPackage: pulumi.Output<outputs.mediapackage.PackagingConfigurationDashPackage | undefined>;
    /**
     * An HTTP Live Streaming (HLS) packaging configuration.
     */
    readonly hlsPackage: pulumi.Output<outputs.mediapackage.PackagingConfigurationHlsPackage | undefined>;
    /**
     * A Microsoft Smooth Streaming (MSS) PackagingConfiguration.
     */
    readonly mssPackage: pulumi.Output<outputs.mediapackage.PackagingConfigurationMssPackage | undefined>;
    /**
     ...
     */
    readonly tags: pulumi.Output<outputs.mediapackage.PackagingConfigurationTag[] | undefined>;
    /**
