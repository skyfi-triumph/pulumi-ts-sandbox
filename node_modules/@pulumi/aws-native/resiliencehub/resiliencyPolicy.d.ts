...
export declare class ResiliencyPolicy extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResiliencyPolicy;
    /**
     ...
     */
    readonly dataLocationConstraint: pulumi.Output<enums.resiliencehub.ResiliencyPolicyDataLocationConstraint | undefined>;
    readonly policy: pulumi.Output<outputs.resiliencehub.ResiliencyPolicyPolicyMap>;
    /**
    ...
    readonly tags: pulumi.Output<outputs.resiliencehub.ResiliencyPolicyTagMap | undefined>;
    /**
     * Resiliency Policy Tier.
     */
    readonly tier: pulumi.Output<enums.resiliencehub.ResiliencyPolicyTier>;
    /**
