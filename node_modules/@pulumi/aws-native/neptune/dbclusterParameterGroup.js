 ...
 */
class DBClusterParameterGroup extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("DBClusterParameterGroup is deprecated: DBClusterParameterGroup is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new DBClusterParameterGroup(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
DBClusterParameterGroup.__pulumiType = 'aws-native:neptune:DBClusterParameterGroup';
