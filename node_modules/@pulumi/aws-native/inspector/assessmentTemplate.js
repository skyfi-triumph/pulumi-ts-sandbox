...
class AssessmentTemplate extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("AssessmentTemplate is deprecated: AssessmentTemplate is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new AssessmentTemplate(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
AssessmentTemplate.__pulumiType = 'aws-native:inspector:AssessmentTemplate';
