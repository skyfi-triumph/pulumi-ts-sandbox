...
export declare class SecurityConfiguration extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SecurityConfiguration;
    /**
    ...
    readonly securityConfiguration: pulumi.Output<any>;
    /**
