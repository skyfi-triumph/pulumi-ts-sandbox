 ...
 */
export declare class InstanceGroupConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InstanceGroupConfig;
    /**
     * Returns true if the given object is an instance of InstanceGroupConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is InstanceGroupConfig;
    readonly autoScalingPolicy: pulumi.Output<outputs.emr.InstanceGroupConfigAutoScalingPolicy | undefined>;
    readonly bidPrice: pulumi.Output<string | undefined>;
    readonly configurations: pulumi.Output<outputs.emr.InstanceGroupConfigConfiguration[] | undefined>;
    readonly ebsConfiguration: pulumi.Output<outputs.emr.InstanceGroupConfigEbsConfiguration | undefined>;
    ...
    readonly market: pulumi.Output<string | undefined>;
