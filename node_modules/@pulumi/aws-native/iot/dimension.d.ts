 ...
 */
export declare class Dimension extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Dimension;
    /**
     * Returns true if the given object is an instance of Dimension.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Dimension;
    /**
     ...
     */
    readonly stringValues: pulumi.Output<string[]>;
    /**
     * Metadata that can be used to manage the dimension.
     */
    readonly tags: pulumi.Output<outputs.iot.DimensionTag[] | undefined>;
    /**
     * Specifies the type of the dimension.
     */
    readonly type: pulumi.Output<enums.iot.DimensionType>;
    /**
