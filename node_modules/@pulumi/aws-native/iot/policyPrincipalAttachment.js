...
exports.PolicyPrincipalAttachment = void 0;
 ...
 */
class PolicyPrincipalAttachment extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("PolicyPrincipalAttachment is deprecated: PolicyPrincipalAttachment is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new PolicyPrincipalAttachment(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.PolicyPrincipalAttachment = PolicyPrincipalAttachment;
/** @internal */
PolicyPrincipalAttachment.__pulumiType = 'aws-native:iot:PolicyPrincipalAttachment';
//# sourceMappingURL=policyPrincipalAttachment.js.map