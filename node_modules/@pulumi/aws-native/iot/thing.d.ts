...
export declare class Thing extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Thing;
    /**
    ...
    readonly attributePayload: pulumi.Output<outputs.iot.ThingAttributePayload | undefined>;
    readonly thingName: pulumi.Output<string | undefined>;
    /**
