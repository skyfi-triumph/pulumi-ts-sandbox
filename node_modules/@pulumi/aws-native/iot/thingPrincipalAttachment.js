...
class ThingPrincipalAttachment extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("ThingPrincipalAttachment is deprecated: ThingPrincipalAttachment is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new ThingPrincipalAttachment(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
ThingPrincipalAttachment.__pulumiType = 'aws-native:iot:ThingPrincipalAttachment';
