...
export declare class TopicRule extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TopicRule;
    /**
    ...
    readonly tags: pulumi.Output<outputs.iot.TopicRuleTag[] | undefined>;
    readonly topicRulePayload: pulumi.Output<outputs.iot.TopicRulePayload>;
    /**
