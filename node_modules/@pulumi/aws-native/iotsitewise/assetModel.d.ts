 ...
 */
export declare class AssetModel extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AssetModel;
    /**
     * Returns true if the given object is an instance of AssetModel.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AssetModel;
    /**
     * The ARN of the asset model, which has the following format.
     */
    readonly assetModelArn: pulumi.Output<string>;
    /**
     ...
     */
    readonly assetModelCompositeModels: pulumi.Output<outputs.iotsitewise.AssetModelCompositeModel[] | undefined>;
    /**
     * A description for the asset model.
     */
    readonly assetModelDescription: pulumi.Output<string | undefined>;
    /**
     * The hierarchy definitions of the asset model. Each hierarchy specifies an asset model whose assets can be children of any other assets created from this asset model. You can specify up to 10 hierarchies per asset model.
     */
    readonly assetModelHierarchies: pulumi.Output<outputs.iotsitewise.AssetModelHierarchy[] | undefined>;
    /**
     ...
     */
    readonly assetModelName: pulumi.Output<string>;
    /**
     * The property definitions of the asset model. You can specify up to 200 properties per asset model.
     */
    readonly assetModelProperties: pulumi.Output<outputs.iotsitewise.AssetModelProperty[] | undefined>;
    /**
     * A list of key-value pairs that contain metadata for the asset model.
     */
    readonly tags: pulumi.Output<outputs.iotsitewise.AssetModelTag[] | undefined>;
    /**
