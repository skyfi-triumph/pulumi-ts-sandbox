 ...
 */
class ClusterSecurityGroup extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("ClusterSecurityGroup is deprecated: ClusterSecurityGroup is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new ClusterSecurityGroup(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
ClusterSecurityGroup.__pulumiType = 'aws-native:redshift:ClusterSecurityGroup';
//# sourceMappingURL=clusterSecurityGroup.js.map