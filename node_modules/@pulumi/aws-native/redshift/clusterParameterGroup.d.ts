...
export declare class ClusterParameterGroup extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClusterParameterGroup;
    /**
    ...
    readonly parameterGroupFamily: pulumi.Output<string>;
    readonly parameters: pulumi.Output<outputs.redshift.ClusterParameterGroupParameter[] | undefined>;
    readonly tags: pulumi.Output<outputs.redshift.ClusterParameterGroupTag[] | undefined>;
    /**
