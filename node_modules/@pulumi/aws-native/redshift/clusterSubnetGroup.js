...
class ClusterSubnetGroup extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        pulumi.log.warn("ClusterSubnetGroup is deprecated: ClusterSubnetGroup is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        let inputs = {};
        opts = opts || {};
        if (!opts.id) {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("ClusterSubnetGroup is deprecated: ClusterSubnetGroup is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new ClusterSubnetGroup(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
ClusterSubnetGroup.__pulumiType = 'aws-native:redshift:ClusterSubnetGroup';
