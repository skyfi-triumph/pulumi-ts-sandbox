 ...
 */
export declare class ClusterSecurityGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClusterSecurityGroup;
    /**
     * Returns true if the given object is an instance of ClusterSecurityGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ClusterSecurityGroup;
    readonly description: pulumi.Output<string>;
    readonly tags: pulumi.Output<outputs.redshift.ClusterSecurityGroupTag[] | undefined>;
    /**
