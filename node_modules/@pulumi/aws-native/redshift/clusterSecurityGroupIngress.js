...
exports.ClusterSecurityGroupIngress = void 0;
 ...
 */
class ClusterSecurityGroupIngress extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("ClusterSecurityGroupIngress is deprecated: ClusterSecurityGroupIngress is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new ClusterSecurityGroupIngress(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.ClusterSecurityGroupIngress = ClusterSecurityGroupIngress;
/** @internal */
ClusterSecurityGroupIngress.__pulumiType = 'aws-native:redshift:ClusterSecurityGroupIngress';
//# sourceMappingURL=clusterSecurityGroupIngress.js.map