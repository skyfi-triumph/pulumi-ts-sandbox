...
export declare class MultiRegionAccessPoint extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MultiRegionAccessPoint;
    /**
     ...
     */
    readonly publicAccessBlockConfiguration: pulumi.Output<outputs.s3.MultiRegionAccessPointPublicAccessBlockConfiguration | undefined>;
    /**
     * The list of buckets that you want to associate this Multi Region Access Point with.
     */
    readonly regions: pulumi.Output<outputs.s3.MultiRegionAccessPointRegion[]>;
    /**
