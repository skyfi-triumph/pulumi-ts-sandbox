...
export declare class MultiRegionAccessPointPolicy extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MultiRegionAccessPointPolicy;
    /**
     ...
     */
    readonly mrapName: pulumi.Output<string>;
    /**
     ...
     */
    readonly policyStatus: pulumi.Output<outputs.s3.PolicyStatusProperties>;
    /**
