 ...
 */
export declare class StorageLens extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StorageLens;
    /**
     * Returns true if the given object is an instance of StorageLens.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is StorageLens;
    readonly storageLensConfiguration: pulumi.Output<outputs.s3.StorageLensConfiguration>;
    /**
     * A set of tags (key-value pairs) for this Amazon S3 Storage Lens configuration.
     */
    readonly tags: pulumi.Output<outputs.s3.StorageLensTag[] | undefined>;
    /**
