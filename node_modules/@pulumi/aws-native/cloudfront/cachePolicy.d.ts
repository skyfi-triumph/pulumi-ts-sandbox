...
export declare class CachePolicy extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CachePolicy;
    /**
    ...
    readonly cachePolicyConfig: pulumi.Output<outputs.cloudfront.CachePolicyConfig>;
