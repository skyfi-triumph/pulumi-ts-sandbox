...
class ComputeEnvironment extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("ComputeEnvironment is deprecated: ComputeEnvironment is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new ComputeEnvironment(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
ComputeEnvironment.__pulumiType = 'aws-native:batch:ComputeEnvironment';
