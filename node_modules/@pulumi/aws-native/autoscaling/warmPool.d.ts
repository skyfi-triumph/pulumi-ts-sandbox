 ...
 */
export declare class WarmPool extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WarmPool;
    /**
     * Returns true if the given object is an instance of WarmPool.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WarmPool;
    readonly autoScalingGroupName: pulumi.Output<string>;
    readonly maxGroupPreparedCapacity: pulumi.Output<number | undefined>;
    readonly minSize: pulumi.Output<number | undefined>;
    readonly poolState: pulumi.Output<string | undefined>;
    /**
