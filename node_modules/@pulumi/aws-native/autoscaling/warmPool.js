...
exports.WarmPool = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
/**
 * Resource schema for AWS::AutoScaling::WarmPool.
 */
class WarmPool extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new WarmPool(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
WarmPool.__pulumiType = 'aws-native:autoscaling:WarmPool';
