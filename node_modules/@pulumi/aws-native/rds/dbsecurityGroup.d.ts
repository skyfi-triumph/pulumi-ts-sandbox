 ...
 */
export declare class DBSecurityGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DBSecurityGroup;
    /**
     * Returns true if the given object is an instance of DBSecurityGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DBSecurityGroup;
    readonly dBSecurityGroupIngress: pulumi.Output<outputs.rds.DBSecurityGroupIngress[]>;
    readonly eC2VpcId: pulumi.Output<string | undefined>;
    readonly groupDescription: pulumi.Output<string>;
    readonly tags: pulumi.Output<outputs.rds.DBSecurityGroupTag[] | undefined>;
    /**
