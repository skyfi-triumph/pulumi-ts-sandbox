...
export declare class PrivateDnsNamespace extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateDnsNamespace;
    /**
    ...
    readonly properties: pulumi.Output<outputs.servicediscovery.PrivateDnsNamespaceProperties | undefined>;
    readonly tags: pulumi.Output<outputs.servicediscovery.PrivateDnsNamespaceTag[] | undefined>;
