...
class PrivateDnsNamespace extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("PrivateDnsNamespace is deprecated: PrivateDnsNamespace is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new PrivateDnsNamespace(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
PrivateDnsNamespace.__pulumiType = 'aws-native:servicediscovery:PrivateDnsNamespace';
