...
export declare class PublicDnsNamespace extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PublicDnsNamespace;
    /**
    ...
    readonly properties: pulumi.Output<outputs.servicediscovery.PublicDnsNamespaceProperties | undefined>;
    readonly tags: pulumi.Output<outputs.servicediscovery.PublicDnsNamespaceTag[] | undefined>;
    /**
