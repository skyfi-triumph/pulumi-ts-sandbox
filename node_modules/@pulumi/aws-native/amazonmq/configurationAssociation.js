...
exports.ConfigurationAssociation = void 0;
 ...
 */
class ConfigurationAssociation extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("ConfigurationAssociation is deprecated: ConfigurationAssociation is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new ConfigurationAssociation(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
ConfigurationAssociation.__pulumiType = 'aws-native:amazonmq:ConfigurationAssociation';
