 ...
 */
export declare class ConfigurationAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationAssociation;
    /**
     * Returns true if the given object is an instance of ConfigurationAssociation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ConfigurationAssociation;
    readonly broker: pulumi.Output<string>;
    readonly configuration: pulumi.Output<outputs.amazonmq.ConfigurationAssociationConfigurationId>;
    /**
