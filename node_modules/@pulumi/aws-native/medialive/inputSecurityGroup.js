...
class InputSecurityGroup extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("InputSecurityGroup is deprecated: InputSecurityGroup is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new InputSecurityGroup(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
InputSecurityGroup.__pulumiType = 'aws-native:medialive:InputSecurityGroup';
