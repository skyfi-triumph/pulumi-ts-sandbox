...
export declare class InputSecurityGroup extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InputSecurityGroup;
    /**
    ...
    readonly whitelistRules: pulumi.Output<outputs.medialive.InputSecurityGroupInputWhitelistRuleCidr[] | undefined>;
    /**
