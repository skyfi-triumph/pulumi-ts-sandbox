...
exports.PublicRepository = void 0;
 ...
 */
class PublicRepository extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        pulumi.log.warn("PublicRepository is deprecated: PublicRepository is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new PublicRepository(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
PublicRepository.__pulumiType = 'aws-native:ecr:PublicRepository';
