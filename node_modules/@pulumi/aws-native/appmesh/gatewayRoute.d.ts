...
export declare class GatewayRoute extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GatewayRoute;
    /**
    ...
    readonly gatewayRouteName: pulumi.Output<string | undefined>;
    ...
    readonly tags: pulumi.Output<outputs.appmesh.GatewayRouteTag[] | undefined>;
