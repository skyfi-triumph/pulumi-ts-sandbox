...
export declare class VirtualGateway extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualGateway;
    /**
    ...
    readonly meshOwner: pulumi.Output<string | undefined>;
    readonly resourceOwner: pulumi.Output<string>;
    readonly spec: pulumi.Output<outputs.appmesh.VirtualGatewaySpec>;
    readonly tags: pulumi.Output<outputs.appmesh.VirtualGatewayTag[] | undefined>;
    readonly uid: pulumi.Output<string>;
    readonly virtualGatewayName: pulumi.Output<string | undefined>;
    /**
