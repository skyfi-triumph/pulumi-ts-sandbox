...
export declare class Partition extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Partition;
    /**
    ...
    readonly partitionInput: pulumi.Output<outputs.glue.PartitionInput>;
