...
class SecurityConfiguration extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        pulumi.log.warn("SecurityConfiguration is deprecated: SecurityConfiguration is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.");
        return new SecurityConfiguration(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
SecurityConfiguration.__pulumiType = 'aws-native:glue:SecurityConfiguration';
