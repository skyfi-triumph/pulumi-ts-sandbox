...
export declare class MLTransform extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MLTransform;
    /**
    ...
    readonly inputRecordTables: pulumi.Output<outputs.glue.MLTransformInputRecordTables>;
    ...
    readonly transformEncryption: pulumi.Output<outputs.glue.MLTransformTransformEncryption | undefined>;
    readonly transformParameters: pulumi.Output<outputs.glue.MLTransformTransformParameters>;
