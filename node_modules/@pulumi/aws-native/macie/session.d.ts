...
export declare class Session extends pulumi.CustomResource {
     ...
     */
    readonly findingPublishingFrequency: pulumi.Output<enums.macie.SessionFindingPublishingFrequency | undefined>;
    /**
     ...
     */
    readonly status: pulumi.Output<enums.macie.SessionStatus | undefined>;
    /**
