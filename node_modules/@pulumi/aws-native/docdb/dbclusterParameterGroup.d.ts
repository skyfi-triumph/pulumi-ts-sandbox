...
export declare class DBClusterParameterGroup extends pulumi.CustomResource {
    ...
    readonly tags: pulumi.Output<outputs.docdb.DBClusterParameterGroupTag[] | undefined>;
    /**
...
export interface DBClusterParameterGroupArgs {
    ...
    parameters: any;
    tags?: pulumi.Input<pulumi.Input<inputs.docdb.DBClusterParameterGroupTagArgs>[]>;
}
